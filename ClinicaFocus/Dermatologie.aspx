<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dermatologie.aspx.cs" Inherits="ClinicaFocus.Dermatologie" %>
<!doctype html>
		  ...
		  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
			...
			<li class="nav-item dropdown">
			  ...
			  <ul class="dropdown-menu">
				<li><a class="dropdown-item active fw-bold" href="Dermatologie.aspx">Dermatologie</a></li>
