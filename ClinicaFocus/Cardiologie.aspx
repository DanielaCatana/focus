<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cardiologie.aspx.cs" Inherits="ClinicaFocus.Cardiologie" %>
<!doctype html>
		  ...
		  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
			...
			<li class="nav-item dropdown">
			  ...
			  <ul class="dropdown-menu">
				...
				<li><a class="dropdown-item active fw-bold" href="Cardiologie.aspx">Cardiologie</a></li>
