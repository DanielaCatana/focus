<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MedicinaMuncii.aspx.cs" Inherits="ClinicaFocus.MedicinaMuncii" %>
<!doctype html>
		  ...
		  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
			...
			<li class="nav-item dropdown">
			  ...
			  <ul class="dropdown-menu">
				...
				<li><a class="dropdown-item active fw-bold" href="MedicinaMuncii.aspx">Medicina muncii</a></li>
			  </ul>
			</li>
			<li class="nav-item">
